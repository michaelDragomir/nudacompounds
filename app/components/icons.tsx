...
export function FlaskIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" className={className}>
      <path d="M9 3h6M10 3v6l-5.5 9a2 2 0 0 0 1.7 3h11.6a2 2 0 0 0 1.7-3L14 9V3" strokeLinecap="round" strokeLinejoin="round" />
...
export function CheckBadgeIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" className={className}>
      <path d="M12 3l2.2 1.3 2.5-.3 1 2.3 2.1 1.3-.5 2.4.5 2.4-2.1 1.3-1 2.3-2.5-.3L12 17l-2.2-1.3-2.5.3-1-2.3-2.1-1.3.5-2.4-.5-2.4 2.1-1.3 1-2.3 2.5.3z" strokeLinejoin="round" />
      <path d="M9 12l2 2 4-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
