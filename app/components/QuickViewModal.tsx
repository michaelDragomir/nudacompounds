...
import { ProductCoaCard } from './ProductCoaCard';
...
export function QuickViewModal({ product, onClose }: QuickViewModalProps) {
	...
	return (
		...
		>
			<div
				className='relative border border-amber/40 flex w-full max-w-2xl flex-col rounded-2xl bg-white shadow-2xl'
			...
			>
				...
				<div className='p-5'>
					...
					<ProductCoaCard product={product} />
				</div>
			</div>
		</div>
	);
