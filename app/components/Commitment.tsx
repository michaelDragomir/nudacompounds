		...
		<section className='relative bg-navy overflow-hidden'>
			...
			<div className='relative max-w-3xl mx-auto px-6 py-18 text-center'>
				...
				<p className='mt-5 text-offwhite/70 leading-relaxed'>
					Every product Nuda Compounds distributes is intended strictly for
					laboratory research. We hold ourselves to a standard of responsible
					sourcing and full documentation, so the researchers who rely on us
					always know exactly what they&rsquo;re getting.
				</p>
				...
				<div className='mt-10 rounded-xl border border-offwhite/15 bg-offwhite/5 px-6 py-4 text-xs text-offwhite/60 leading-relaxed'>
					...
					within controlled laboratory settings. Not intended for human
					consumption, veterinary use, or therapeutic application.
				</div>
			</div>
		</section>
	);
