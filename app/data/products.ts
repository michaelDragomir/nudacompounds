...
export const products: Product[] = [
	...
	},
	{
		...
		category: 'Metabolic Research',
		description:
			'AGLP-2TRZ is a synthetic peptide research material used in laboratory investigation of GLP-1 and GIP receptor signaling. Its distinctive dual-receptor profile makes it a compelling research candidate for studying receptor interactions, downstream signaling pathways, and metabolic signaling mechanisms.',
		purity: '≥99%',
		size: '10mg vial',
		price: 40,
		bulkPrice10: 240,
	...
	},
	{
		...
		category: 'Metabolic Research',
		description:
			'glutathione is a naturally occurring tripeptide composed of glutamine acid, cysteine, and glycine. It is a powerful antioxidant and a potent immune modulator. It is also a powerful anti-inflammatory agent.  It is widely studied as a biological compound and serves as a powerful tool for research in cellular redox systems and related biochemical processes.',
		purity: '≥99%',
		size: '1500mg vial',
		price: 50,
		bulkPrice10: 1200,
		image: '/images/gluta.png',
		inStock: true,
		kitEligible: false,
		coa: {
			batch: 'NUDA-1016',
